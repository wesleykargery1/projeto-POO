# Documentação do Projeto: RPG "Medo do Desconhecido" em Python utilizando pygame
...
Medo do Desconhecido é um rpg que retrata a história de uma família de pesquisadores que vivem em um mundo onde as almas possuem características únicas que indicam os traços predominantes de suas personalidades. George buscava fazer com que os animais conseguissem transcender a um nível superior, em busca de uma raça perfeita, mas isso acaba levando a sua morte; Lucca parte a uma floresta para procurar pistas sobre o que levou a morte de George, lá ele passará por vários desafios enquanto busca a verdade.  
